      ...
      <div className="flex items-center gap-2 flex-wrap md:flex-nowrap">
        ...
        <div className="flex items-center gap-0.5 border-l border-slate-200/60 pl-2 ml-1">
          <button 
            ...
            className="px-3 py-1.5 mr-1 bg-slate-900 text-white hover:bg-slate-800 rounded-lg text-xs font-bold transition-all shadow-sm active:scale-95 flex-shrink-0"
          >
            Nueva Orden
          </button>
          {[
