...
type AjustesRow = { id:number; updatedAt:Date; locale:string; currency:string; taxPct:number; propinaPct?:number; businessName:string; ticketFooter:string; logoUrl:string; printerIp?:string|null; printerPort?:number|null; serialBaud?:number|null }
...
type Pedido = { id:number; numero:number; createdAt:Date; subtotalCents:number; impuestoCents:number; itebisCents:number; propinaCents:number; descuentoCents:number; totalCents:number; mesa?:{nombre:string}|null; subCuenta?:number; items:PedidoItem[] }
